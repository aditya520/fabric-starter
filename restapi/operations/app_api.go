...
func (o *AppAPI) Validate() error {
	...
	if o.NetworkCreateHandler == nil {
		unregistered = append(unregistered, "Network.CreateHandler")
	}
...
func (o *AppAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/network/create"] = network.NewCreate(o.context, o.NetworkCreateHandler)
